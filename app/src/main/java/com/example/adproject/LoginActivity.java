...
public class LoginActivity extends AppCompatActivity {
    ...
    private void login() {
        ...
        String url = "http://10.0.2.2:8080/api/login"; // 比如 "http://10.249.31.248:8080/api/login"
                ...
                if (response.isSuccessful()) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            LoginActivity.this.finish(); // 结束当前的Activity，可能是LoginActivity
                        }
                    });
